...
const QuizStart = () => {
  ...
  return (
    <div className="py-[66px] font-liador relative px-[100px] border border-solid bg-white  rounded-lg">
      <Image
        src={userBg}
        width={150}
        height={160}
      ...
      <div>
        ...
        {/* Input from */}
        <from className="grid grid-cols-2 gap-5 ">
          <label
      ...
      <div className="flex justify-between w-full">
        <Link className="block" href={"/quiz/01quiz"}>
          <button
            type="submit"
            className="bg-[#B3B3B3] justify-center gap-[10px]  mt-6  py-3 px-8 rounded text-white font-semibold flex items-center"
          >
            পূর্ববর্তী প্রশ্ন
            <IoArrowForwardSharp />
          </button>
        ...
        <Link className=" block" href={"/quiz/01quiz"}>
          <button
            type="submit"
            className="bg-secondaryGradiant justify-center gap-[10px]  mt-6  py-3 px-8 rounded text-white font-semibold flex items-center"
          >
            পরবর্তী প্রশ্ন
            <IoArrowForwardSharp />
          </button>
