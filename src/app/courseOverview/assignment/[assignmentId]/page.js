...
const StartAssignment = () => {
  return (
    <div className="py-[66px] font-liador relative px-[30px] border border-solid bg-white  rounded-lg">
      <Image
        src={userBg}
        width={100}
        height={107}
      ...
      {/* Assignment Marks */}
      <div className="flex justify-center items-center gap-4 bg-[rgba(247,247,247,0.50)] py-6  border border-solid border-black/30 rounded ">
